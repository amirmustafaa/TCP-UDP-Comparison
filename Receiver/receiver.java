...
public class receiver {
    ...
    public static void main(String args[]) throws Exception {
		...
		FileWriter writer = new FileWriter("results1_100mb_LAN.txt"); //File writer for results file
		...
		int i = 1;
        String hex = checksum("StandardFile3.txt", md);
		...
		System.out.println("I am done receiving the file " + numTimes +" times, and the total time is: " + (double)totalTime + "ms with " + numErrors+ " Errors.");
		...
		writer.write("I am done receiving the file " + numTimes +" times, and the total time is: " + (double)totalTime+ "ms with " + numErrors+ " Errors. \n");
		writer.close();
